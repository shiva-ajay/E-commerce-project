...
const ProductDetails = ({ data }) => {
  ...
  return (
    <div className="bg-white">
      {data && data.image_Url && data.image_Url.length > 0 ? ( // Improved conditional rendering
              ...
              <div className="w-full 800px:w-[50%]">
                ...
                <div className="w-full flex">
                  {data.image_Url.map(
                    (
                      imageUrl,
                      index // Dynamically generate image elements
                    ) => (
                      <div
                        key={index}
                        ...
                        onClick={() => setSelect(index)} // Update selected image on click
                      >
                        <img
                          src={imageUrl.url}
